...
contract NFTMarkPlace is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIDs;
    using SafeMath for uint256;
    mapping(uint256 => NFTListing) private _listings;

    constructor() ERC721("DevNFT", "NFTCoin") {    }
    // even

    event NFTTransfer(uint256 tokenID, address from, address to, string tokenURI, uint price);
